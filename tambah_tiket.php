...
<html lang="en">
 ...
 <!-- Form Registrasi -->
  <div class="container">
    <h3 class="text-center mt-3 mb-5">SILAHKAN TAMBAH BUS DAN DESTINASI WISATA</h3>
        ...
        <div class="form-group">
          ...
          <div class="form-check">
            <label class="form-check-label">
              <input type="radio" class="form-check-input" value="AKAP" name="jenis_rute" checked>Junior Bus(39 Kursi) 
            </label>
          </div>
          <div class="form-check">
            <label class="form-check-label">
              <input type="radio" class="form-check-input" value="AKDP" name="jenis_rute">Big Bus (59 Kursi)
            </label>
          </div>
         </div>
        <div class="form-group">
          <label for="stok_tiket1">Masukkan Stok Tiket</label>
          <input type="text" class="form-control" id="stok_tiket1" name="stok_tiket">
        </div>
        <div class="form-group">
          <label for="harga_tiket1">Masukkan Harga Tiket</label>
